...
const NavMenu = () => {
  ...
  const handleCollapseToggle = (event: React.MouseEvent<Element>) => {
    const target = event.target as HTMLElement

    setSectionCollapsed({
      ...initialState,
      [target.id]: !sectionCollapsed[target.id],
    })
  }
  ...
  return (
    <div id="nav-menu">
      <div id="focal-nav-menu" className="nav-menu-column">
        ...
        />
        <button type="button" id="compact-nav-search-button">
          <svg
      ...
      <div id="nav-menu-collapsable-sections">
        ...
        >
          ...
          <li>
            <a href="#">Previous General Assembly Session Forms</a>
          </li>
        </NavMenuCompactEntry>
        ...
        >
          <li>
            <a href="#">Precinct Demographics and Redistricting</a>
          </li>
          <li>
